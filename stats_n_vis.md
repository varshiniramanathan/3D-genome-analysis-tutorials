...
There is no absolute metric for evaluating these numbers. However, for helpful context, here are the `pairtools stats` metrics for several Micro-C and RCMC generated by the Hansen Lab (Fig. 7b from Huseyin et al., Nat Protocols (2026)).

![Description of the read statistics of different Micro-C datasets](assets/images/huseyin_fig_7.png)
